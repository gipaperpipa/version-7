...
async function upsertMembership(demoUserId: string, demoOrganizationId: string) {
...
async function upsertFundingVariant(
  programId: string,
  config: {
    code: string;
    name: string;
    ...
    maxLoanPct: string | null;
    maxLoanPerSqm: string | null;
    rentCapEurSqm: string | null;
    loanCapPct: string | null;
    subsidyEligibleSharePct: string | null;
...
async function upsertPlanningParameter(
